...
const RealEstate = () => {
  ...
  return (
    <div id="aerospace" className="title-container">
      ...
      >
        <h1 className="aerospace-title">RealEstate∞</h1>
      ...
      {expanded && (
       ...
       <p>
       RealEstate Industry Solutions
       </p>
       {showDescription && (
         <div className="full-description">
           <h2>Transforming RealEstate Sector with Innovative Solutions</h2>
           <p>
      ...
      {/* Help Section */}
      <div className="realestate-help-section">
        ...
        <div className="right-content">
          <div className="industry-navigation">
            <p className="industry-path">» INDUSTRIES / RealEstate</p>
          </div>
