...
const Construction = () => {
  ...
  return (
    <div id="aerospace" className="title-container relative top-[60px]">
      ...
      >
        <h1 className="aerospace-title">Construction∞</h1>
      ...
      {expanded && (
       ...
       {showDescription && (
         <div className="full-description">
           <h2>Transforming Construction Industry with Innovative Solutions</h2>
           <p>
             At AMXSOL∞, we understand the unique challenges and opportunities within the construction industry. Our comprehensive suite of solutions shall help navigate the complexities of the construction field by providing industry-ready talent with solutions.
           </p>
         </div>
       )}
      ...
      {/* Help Section */}
      <div className="construction-help-section">
        ...
        <div className="right-content">
          <div className="industry-navigation">
            <p className="industry-path">» INDUSTRIES / CONSTRUCTION</p>
          </div>
