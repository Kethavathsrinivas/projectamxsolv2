...
const Technology = () => {
  ...
  return (
    <div id="aerospace" className="title-container">
      ...
      >
        <h1 className="aerospace-title">Technology∞</h1>
      ...
      {expanded && (
       ...
       {showDescription && (
         <div className="full-description">
           <h2>Transforming Technology Sector with Innovative Solutions</h2>
           <p>
      ...
      {/* Help Section */}
      <div className="technology-help-section">
      <div className="help-bg">
        ...
        <div className="right-content">
          <div className="industry-navigation">
            <p className="industry-path">» INDUSTRIES / Technology</p>
          </div>
