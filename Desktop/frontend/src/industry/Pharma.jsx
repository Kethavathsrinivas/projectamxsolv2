...
const Pharma = () => {
  ...
  return (
    <div id="aerospace" className="title-container">
      ...
      >
        <h1 className="aerospace-title">Pharma∞</h1>
      ...
      {expanded && (
       ...
       {showDescription && (
         <div className="full-description">
           <h2>Transforming PHARMA Sector with Innovative Solutions</h2>
           <p>
      ...
      {/* Help Section */}
      <div className="pharma-help-section">
        ...
        <div className="right-content">
          <div className="industry-navigation">
            <p className="industry-path">» INDUSTRIES / PHARMA</p>
          </div>
