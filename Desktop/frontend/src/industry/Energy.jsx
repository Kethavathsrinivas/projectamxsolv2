...
const Energy = () => {
  ...
  return (
    <div id="aerospace" className="title-container relative top-[60px]">
      ...
      >
        <h1 className="aerospace-title">Energy∞</h1>
      ...
      {expanded && (
        ...
        {showDescription && (
          <div className="full-description">
            <h2>Transforming ENERGY Sector with Innovative Solutions</h2>
            <p>
              At AMXSOL∞, we understand the unique challenges and opportunities within the energy sector. Our comprehensive suite of solutions shall help navigate the complexities of the energy sector by providing industry-ready talent with solutions.
            </p>
          </div>
        )}
      ...
      {/* Help Section */}
      <div className="energy-help-section">
        ...
        <div className="right-content">
          <div className="industry-navigation">
            <p className="industry-path">» INDUSTRIES / ENERGY</p>
          </div>
