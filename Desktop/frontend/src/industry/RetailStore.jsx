...
const RetailStore = () => {
  ...
  return (
    <div id="aerospace" className="title-container">
      ...
      >
        <h1 className="aerospace-title">RetailStore∞</h1>
      ...
      {expanded && (
       ...
       <p>
       RetailStore Industry Solutions
       </p>
       {showDescription && (
         <div className="full-description">
           <h2>Transforming RetailStore Sector with Innovative Solutions</h2>
           <p>
      ...
      {/* Help Section */}
      <div className="retailstore-help-section">
      <div className="help-bg">
        ...
        <div className="right-content">
          <div className="industry-navigation">
            <p className="industry-path">» INDUSTRIES / RETAILSTORE</p>
          </div>
