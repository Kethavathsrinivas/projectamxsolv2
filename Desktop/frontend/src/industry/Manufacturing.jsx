...
const Manufacturing = () => {
  ...
  return (
    <div id="aerospace" className="title-container">
      ...
      >
        <h1 className="aerospace-title">Manufacturing∞</h1>
      ...
      {expanded && (
       ...
       {showDescription && (
         <div className="full-description">
           <h2>Transforming MANUFACTURING Sector with Innovative Solutions</h2>
           <p>
      ...
      {/* Help Section */}
      <div className="manufacturing-help-section">
        ...
        <div className="right-content">
          <div className="industry-navigation">
            <p className="industry-path">» INDUSTRIES / MANUFACTURING</p>
          </div>
