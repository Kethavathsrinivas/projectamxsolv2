...
const Insurance = () => {
  ...
  return (
    <div id="aerospace" className="title-container">
      ...
      >
        <h1 className="aerospace-title">Insurance∞</h1>
      ...
      {expanded && (
       ...
       {showDescription && (
         <div className="full-description">
           <h2>Transforming INSURANCE Sector with Innovative Solutions</h2>
           <p>
      ...
      {/* Help Section */}
      <div className="insurance-help-section">
        ...
        <div className="right-content">
          <div className="industry-navigation">
            <p className="industry-path">» INDUSTRIES / INSURANCE</p>
          </div>
