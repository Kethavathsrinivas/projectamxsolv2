...
const Education = () => {
  ...
  return (
    <div id="aerospace" className="title-container relative top-[60px]">
      ...
      >
        <h1 className="aerospace-title">Education∞</h1>
      ...
      {expanded && (
        ...
        {showDescription && (
          <div className="full-description">
            <h2>Transforming EDUCATION Field with Innovative Solutions</h2>
            <p>
              At AMXSOL∞, we understand the unique challenges and opportunities within the education field. Our comprehensive suite of solutions shall help navigate the complexities of the education sector by providing ready talent with solutions.
            </p>
          </div>
        )}
      ...
      <div className="education-help-section">
        ...
        <div className="right-content">
          <div className="industry-navigation">
            <p className="industry-path">» INDUSTRIES / EDUCATION</p>
          </div>
