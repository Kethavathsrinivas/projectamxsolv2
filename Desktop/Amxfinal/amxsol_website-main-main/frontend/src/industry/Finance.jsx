...
const Finance = () => {
  ...
  return (
    <div id="aerospace" className="title-container relative top-[60px]">
      ...
      >
        <h1 className="aerospace-title">Finance∞</h1>
      ...
      {expanded && (
       ...
       {showDescription && (
         <div className="full-description">
           <h2>Transforming FINANCE Sector with Innovative Solutions</h2>
           <p>
      ...
      {/* Help Section */}
      <div className="finance-help-section">
        ...
        <div className="right-content">
          <div className="industry-navigation">
            <p className="industry-path">» INDUSTRIES / FINANCE</p>
          </div>
